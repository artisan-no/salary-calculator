...
export default function SalaryCalculator(): JSX.Element {
  ...
  const baseSalaryMatrix = [
    ...
    { experience: 7, salary: baseAmount * 4.5 },
    { experience: 8, salary: baseAmount * 4.5 },
    { experience: 9, salary: baseAmount * 4.5 },
    { experience: 10, salary: baseAmount * 5 },
    { experience: 11, salary: baseAmount * 5 },
    { experience: 12, salary: baseAmount * 5 },
    { experience: 13, salary: baseAmount * 5 },
    { experience: 14, salary: baseAmount * 5.5 },
    { experience: 15, salary: baseAmount * 5.5 },
    { experience: 16, salary: baseAmount * 5.5 },
    { experience: 17, salary: baseAmount * 5.5 },
    { experience: 18, salary: baseAmount * 6 },
    { experience: 19, salary: baseAmount * 6 },
    { experience: 20, salary: baseAmount * 6 },
    { experience: 21, salary: baseAmount * 6 },
    { experience: 22, salary: baseAmount * 6 },
    { experience: 23, salary: baseAmount * 6 },
    { experience: 24, salary: baseAmount * 6 },
    { experience: 25, salary: baseAmount * 6 },
    { experience: 26, salary: baseAmount * 6.5 },
    { experience: 27, salary: baseAmount * 6.5 },
    { experience: 28, salary: baseAmount * 6.5 },
    { experience: 29, salary: baseAmount * 6.5 },
    { experience: 30, salary: baseAmount * 7 },
  ]
